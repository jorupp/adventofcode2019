    ...
    public class Part1 : BasePart
    {
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                var parsed = lines.Select(i => re.Match(i).Groups.OfType<Group>().Skip(1).Select(ii => int.Parse(ii.Value)).ToList()).ToList();
                var viable = (from p1 in parsed
                    from p2 in parsed
                        //where p1[0] < p2[0] || (p1[0] == p2[0] && p1[1] < p2[1])
                              where p1[3] > 0
                    where p1[3] <= p2[4]
        ...
        {
            RunScenario("initial", @"root@ebhq-gridcenter# df -h
