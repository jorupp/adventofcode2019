        ...
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                void Dump()
                {
                    ...
                    var s = 0;
                    for (var y = nmx + 1; y <= my - 1; y++)
                    {
                        for (var x = nmy + 1; x <= mx - 1; x++)
                        {
                            var value = (map.TryGetValue((x, y), out var v) ? v : ' ');
                            var value1 = (map.TryGetValue((x-1, y), out var v1) ? v1 : ' ');
                            var value2 = (map.TryGetValue((x+1, y), out var v2) ? v2 : ' ');
                            var value3 = (map.TryGetValue((x, y-1), out var v3) ? v3 : ' ');
                            var value4 = (map.TryGetValue((x, y+1), out var v4) ? v4 : ' ');
