...
namespace AoC.Year2019.Day9
{
    ...
    {
        protected void RunScenario(string title, string input, long inputValue)
        {
            RunScenario(title, () =>
            {
                ...
                Simulate(initialData, inputData, output, 0);
