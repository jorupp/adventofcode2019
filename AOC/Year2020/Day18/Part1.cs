    ...
    public class Part1 : BasePart
    {
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                {
                    var position = 0;
                    sum += Evaluate(line, true, ref position);
                }
        ...
        private long Evaluate(string input, bool isRoot, ref int position)
        {
            long value = 0;
            var op = '+';
            ...
            while (true)
            {
                ...
                {
                    position++;
                    apply(Evaluate(input, false, ref position));
                ...
                else
                {
                    ...
                    apply(int.Parse(input[position].ToString()));
                    position++;
                }
            }
        }
