    ...
    public class Part1 : BasePart
    {
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                ...
                var q = lines.Where(i =>
                {
                    var c = i.pw.Where(ii => ii == i.letter).Count();
                    return i.min <= c && c <= i.max;
                });


                var q2 = lines.Where(i =>
                {
                    // ^ == XOR
                    //return i.pw[i.min - 1] == i.letter ^ i.pw[i.max - 1] == i.letter;
                    var c = (i.pw[i.min - 1] == i.letter ? 1 : 0) + 
                        (i.pw[i.max - 1] == i.letter  ? 1 : 0);
                    return c == 1;
                });
                ...
                Console.WriteLine("part 1: " + q.Count());
                Console.WriteLine("part 2: " + q2.Count());
            });
        }

        public override void Run()
        {
            RunScenario("initial", @"1-3 a: abcde
1-3 b: cdefg
2-9 c: ccccccccc");
            //return;
            RunScenario("part1", @"1-14 b: bbbbbbbbbbbbbbbbbbb
