...
namespace AoC.Year2020.Day4 
{
    public class Part1 : BasePart
    {
        protected void RunScenario(string title, string input)
        {
            RunScenario(title, () =>
            {
                var lines = input.Replace("\r","").Split(new[] { '\n' });
                ...
                var valid = passports.Where(i => need.All(ii => i.ContainsKey(ii))).ToList();
        ...
        {
            RunScenario("initial", @"ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
iyr:2011 ecl:brn hgt:59in");
            //return;
            RunScenario("part1", @"iyr:2013 hcl:#ceb3a1
hgt:151cm eyr:2030
byr:1943 ecl:grn
