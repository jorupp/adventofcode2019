...
namespace AOC.Year2022.Day11
{
    public class Part2 : BasePart
    {
        ...
        // 11:30:15 -> 12:29:55, time: 59m40s, 100 @ 18m05s
        ...
        {
            long iModFactor = 19 * 23 * 13 * 17;
            RunScenario("initial", new[]
            {
                new Monkey(iModFactor, new long[] { 79, 98 }, o => o * 19, i => i %23 == 0  ? 2 : 3),
                new Monkey(iModFactor, new long[] { 54, 65, 75, 74 }, o => o +6, i => i % 19 == 0  ? 2: 0),
                new Monkey(iModFactor, new long[] { 79, 60, 97 }, o => o * o, i => i % 13 == 0  ? 1 : 3),
                new Monkey(iModFactor, new long[] { 74 }, o => o + 3, i => i % 17 == 0  ? 0 : 1),
            });
            //return;
            ...
            //});
            //return;
            var p2ModFactor = 5 * 11 * 2 * 7 * 17 * 19 * 3 * 13;
            RunScenario("part2", new[]
            {
                new Monkey(p2ModFactor, new long[] { 92, 73, 86, 83, 65, 51, 55, 93 }, old => old * 5, i => i % 11 == 0 ? 3 : 4),
                new Monkey(p2ModFactor, new long[] { 99, 67, 62, 61, 59, 98 }, old => old * old, i => i % 2 == 0 ? 6 : 7),
                new Monkey(p2ModFactor, new long[] { 81, 89, 56, 61, 99 }, old => old * 7, i => i % 5 == 0 ? 1 : 5),
                new Monkey(p2ModFactor, new long[] { 97, 74, 68 }, old => old + 1, i => i % 17 == 0 ? 2 : 5),
                new Monkey(p2ModFactor, new long[] { 78, 73 }, old => old + 3, i => i % 19 == 0 ? 2 : 3),
                new Monkey(p2ModFactor, new long[] { 50 }, old => old + 5, i => i % 7 == 0 ? 1 : 6),
                new Monkey(p2ModFactor, new long[] { 95, 88, 53, 75 }, old => old + 8, i => i % 3 == 0 ? 0 : 7),
                new Monkey(p2ModFactor, new long[] { 50, 77, 98, 85, 94, 56, 89 }, old => old + 2, i => i % 13 == 0 ? 4 : 0),
            });
        ...
        public class Monkey
        {
            ...
            private readonly long modFactor;
            private readonly Func<long, long> op;
            private readonly Func<long, long> test;
            public long count = 0;

            public Monkey(long modFactor, long[] startingItems, Func<long, long> op, Func<long, long> test)
            {
